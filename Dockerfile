...
RUN apt-get update && apt-get install -y --no-install-recommends ca-certificates-java=20161107~bpo8+1 m2ee-tools openjdk-8-jre-headless postgresql-client procps vim-nox curl net-tools tcpdump && apt-get clean
